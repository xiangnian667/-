...
let externalInputs: Record<string, InputState> = {
  p1: { up: false, down: false, left: false, right: false, lightAttack: false, heavyAttack: false, block: false, dash: false },
  p2: { up: false, down: false, left: false, right: false, lightAttack: false, heavyAttack: false, block: false, dash: false },
};

// 触屏手动按下标志
let touchJustPressed: Record<string, Record<string, boolean>> = {
  p1: { lightAttack: false, heavyAttack: false, block: false, dash: false },
  p2: { lightAttack: false, heavyAttack: false, block: false, dash: false },
};
...
export function resetExternalInput(player: 'p1' | 'p2'): void {
  externalInputs[player] = {
    ...
    lightAttack: false, heavyAttack: false, block: false, dash: false,
  };
}

/** 触屏模拟按键按下（仅一帧有效，类似键盘 justPressed） */
export function touchPress(player: 'p1' | 'p2', action: 'lightAttack' | 'heavyAttack' | 'block' | 'dash'): void {
